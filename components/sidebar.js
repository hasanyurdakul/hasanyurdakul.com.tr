...
export default function Sidebar() {
  ...
  const SOCIAL_LINKS = [
    {
      title: "Email",
      url: "mailto:hhasanyurdakul@gmail.com",
      icon: <Envelope />,
    },
    {
      title: "Twitter",
      url: "https://twitter.com/hhasanyurdakul",
      icon: <TwitterLogo />,
    },
    {
      title: "Instagram",
      url: "https://instagram.com/hhasanyurdakul",
      icon: <InstagramLogo />,
    },
    {
      title: "LinkedIn",
      url: "https://www.linkedin.com/in/hasanyurdakul/",
      icon: <LinkedinLogo />,
    },
    {
      title: "Github",
      url: "https://github.com/hasanyurdakul",
      icon: <GithubLogo />,
    },
  ];
